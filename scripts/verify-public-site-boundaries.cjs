...
const requiredRoutes = [
  ...
  "/en/skills",
  "/zh/skills",
  "/en/enterprise/principles",
  "/zh/enterprise/principles",
  "/en/venture/principles",
  "/zh/venture/principles",
  "/en/personal/principles",
  "/zh/personal/principles",
  "/en/copyright",
  "/zh/copyright",
...
const requiredPublicPatterns = [
  ...
  /Consulting Skills/,
  /github\.com\/fzfclee\/consulting-skills/,
  /contact@o2vframework\.com/,
  /Core Principles/,
