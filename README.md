...
- Default public entry is Enterprise-first.
- O2V Enterprise Configuration currently includes AiNOVA and Valence.
...
- O2V Venture Configuration is retained for venture-context opportunity judgment.
- Core Principles are shared by both Enterprise and Venture configurations. Configuration-specific method practices are concrete expressions of the same principles.
...
- `/en/enterprise/copyright`, `/zh/enterprise/copyright`, `/de/enterprise/copyright`
- `/en/venture/copyright`, `/zh/venture/copyright`, `/de/venture/copyright`
...
Keep the 20260607 Enterprise Configuration PDF filenames stable for public download links.

## License

The website source code is licensed under the Apache License 2.0.

The O2V Framework publication text, brand names, citation language, logo assets, downloadable framework materials, AiNOVA, Valence, and derivative methodology assets remain subject to the copyright and rights statements published on the site unless separately licensed in writing.
