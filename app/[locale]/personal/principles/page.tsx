...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: localizedAlternates(locale, "personal/principles")
  };
}

export default async function PersonalPrinciplesPage({ params }: PageProps) {
  const { locale } = await params;
  return <PrinciplesPageContent locale={locale} scope="personal" />;
}
