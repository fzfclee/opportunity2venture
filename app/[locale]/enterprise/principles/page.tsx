...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: localizedAlternates(locale, "enterprise/principles")
  };
}

export default async function EnterprisePrinciplesPage({ params }: PageProps) {
  const { locale } = await params;
  return <PrinciplesPageContent locale={locale} scope="enterprise" />;
}
